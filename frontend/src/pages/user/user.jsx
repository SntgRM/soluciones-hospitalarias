    ...
    <div className="user-management-container">
      ...
      <div className="user-stats-grid">
        ...
        <div className="user-stat-card">
          ...
          <div className="user-stat-content">
            <span className="user-stat-number">
              {users.filter((u) => u.role === "bodega").length}
            </span>
        ...
        <div className="user-stat-card">
          ...
          <div className="user-stat-content">
            <span className="user-stat-number">
              {users.filter((u) => u.role === "ventas").length}
            </span>
                  ...
                  <div className="user-detail-section">
                    ...
                    >
                      <img
                        ...
                        src={
                          selectedUser?.profile_image_url || personsImgs.ISOTIPO
                        }
                        alt="Usuario"
                        onError={handleImageError}
                        style={{
          ...
          <div className="user-modal-content user-delete-modal">
            ...
            <div className="user-delete-modal-body">
              <p>
                ...
                <strong>{`${userToDelete?.first_name}`}</strong>?
              </p>
